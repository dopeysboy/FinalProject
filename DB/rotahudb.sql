...
START TRANSACTION;
USE `rotahudb`;
INSERT INTO `user` (`id`, `username`, `password`, `email`, `role`, `enabled`, `image_url`, `first_name`, `last_name`, `created_at`, `updated_at`) VALUES (1, 'admin', '$2a$10$4SMKDcs9jT18dbFxqtIqDeLEynC7MUrCEUbv1a/bhO.x9an9WGPvm', 'admin@gmail.com', 'admin', 1, NULL, 'john', 'doe', '2022-11-22 00:00:00', '2022-11-22 12:00:00');
...
INSERT INTO `debt` (`id`, `name`, `annual_percentage_rate`, `minimum_monthly_payment`, `initial_balance`, `current_balance`, `priority`, `debt_type_id`, `debt_lender_id`, `user_id`, `created_at`) VALUES (2, 'Mortgage', 4.75, 2478.72, 489000.00, 489000.00, 9, 2, 2, 1, '2022-11-22 12:00:00');
INSERT INTO `debt` (`id`, `name`, `annual_percentage_rate`, `minimum_monthly_payment`, `initial_balance`, `current_balance`, `priority`, `debt_type_id`, `debt_lender_id`, `user_id`, `created_at`) VALUES (3, 'Auto Loan', 9.2, 457.50, 52000, 50750, 8, 3, 4, 1, '2022-11-22 12:00:00');
INSERT INTO `debt` (`id`, `name`, `annual_percentage_rate`, `minimum_monthly_payment`, `initial_balance`, `current_balance`, `priority`, `debt_type_id`, `debt_lender_id`, `user_id`, `created_at`) VALUES (4, 'Student Loan', 2.1, 400, 97000, 97000, 10, 5, 5, 1, '2022-11-22 12:00:00');
...
START TRANSACTION;
USE `rotahudb`;
INSERT INTO `credit_resource` (`id`, `description`, `image_url`, `site_url`, `debt_intensity`, `created_at`, `updated_at`, `enabled`, `user_id`) VALUES (1, 'Debt Consolidation', 'https://www.nerdwallet.com/assets/img/nw-logos/NW_logo_200x200.png', 'https://www.nerdwallet.com/article/finance/consolidate-debt', 40, '2022-11-22 12:00:00', '2022-11-22 12:00:00', 1, 1);
INSERT INTO `credit_resource` (`id`, `description`, `image_url`, `site_url`, `debt_intensity`, `created_at`, `updated_at`, `enabled`, `user_id`) VALUES (2, 'Student Loan Forgiveness', 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Seal_of_the_United_States_Department_of_Education.svg/350px-Seal_of_the_United_States_Department_of_Education.svg.png', 'https://www.ed.gov/category/keyword/loan-forgiveness', 40, '2022-11-22 12:00:00', '2022-11-22 12:00:00', 1, 1);
INSERT INTO `credit_resource` (`id`, `description`, `image_url`, `site_url`, `debt_intensity`, `created_at`, `updated_at`, `enabled`, `user_id`) VALUES (3, 'Debt Information', 'https://assets.experiancs.com/images/logo-experian.svg?hs=2c108564c86d0b65336076616b44b886', 'https://www.experian.com/', 40, '2022-11-22 12:00:00', '2022-11-22 12:00:00', 1, 1);
INSERT INTO `credit_resource` (`id`, `description`, `image_url`, `site_url`, `debt_intensity`, `created_at`, `updated_at`, `enabled`, `user_id`) VALUES (4, 'Wealth Management', 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Charles_Schwab_Corporation_logo.svg/500px-Charles_Schwab_Corporation_logo.svg.png?20210616031939', 'https://www.schwab.com/', 60, '2022-11-22 12:00:00', '2022-11-22 12:00:00', 1, 1);
INSERT INTO `credit_resource` (`id`, `description`, `image_url`, `site_url`, `debt_intensity`, `created_at`, `updated_at`, `enabled`, `user_id`) VALUES (5, 'Real Estate', 'https://www.investopedia.com/thmb/uqoN_RnaHB0jaIEv27Sug6cT_jw=/750x0/filters:no_upscale():max_bytes(150000):strip_icc():format(webp)/Group1805-3b9f749674f0434184ef75020339bd35.jpg', 'hhttps://www.investopedia.com/investing/simple-ways-invest-real-estate/', 60, '2022-11-22 12:00:00', '2022-11-22 12:00:00', 1, 1);
INSERT INTO `credit_resource` (`id`, `description`, `image_url`, `site_url`, `debt_intensity`, `created_at`, `updated_at`, `enabled`, `user_id`) VALUES (6, 'Credit Monitoring', 'https://assets.experiancs.com/images/logo-experian.svg?hs=2c108564c86d0b65336076616b44b886', 'https://www.experian.com/', 60, '2022-11-22 12:00:00', '2022-11-22 12:00:00', 1, 1);
